...
from mmdet.core import anchor_inside_flags, unmap, obb2xyxy_le90, images_to_levels, multi_apply

from mmdet.models.builder import HEADS
from mmdet.models.dense_heads.anchor_head import AnchorHead

@HEADS.register_module()
class OrientedRPNHead(AnchorHead):
    """RPN head.
    ...
    def _init_layers(self):
        ...
        self.rpn_cls = nn.Conv2d(self.feat_channels,
                                 ...
                                 1)
        self.rpn_reg = nn.Conv2d(self.feat_channels, self.num_base_priors * self.reg_dim,
                                 1)
    ...
    def _get_targets_single(self,
        ...
        # 将 obb 转化为 hbb
        gt_hbboxes = obb2xyxy_le90(gt_bboxes)
        ...
        # print(len(neg_inds))
        if len(pos_inds) > 0:
            # print("Oriented_rpn_head: Pos_inds")
